...
2. For standard releases, bump `package.json` and push a tag `vX.Y.Z`; `CHANGELOG.md` is updated automatically by CI (no manual edits).
...
- Do not edit `CHANGELOG.md` directly; it is generated by CI from Conventional Commits.
