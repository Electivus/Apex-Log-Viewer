...
Salesforce CLI is pinned to **2.150.6** in all real-org jobs. The setup helper and proxy images use that same default. Windows/Linux use the project Node 24 runtime; macOS retains the captured Node 20 CLI wrapper after restoring project Node 24. CLI upgrades require new signup/export evidence, not a repository-variable override.
