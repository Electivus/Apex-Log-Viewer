#!/usr/bin/env python3
"""List, acknowledge, reject, or capture actionable AI review feedback on a GitHub PR."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="List actionable AI review feedback and optionally react/resolve it."
    )
...
def main():
    ...
    try:
        ...
        sys.stderr.write(f"gh_pr_review_feedback.py error: {err}\n")
        return 1
    except KeyboardInterrupt:
        sys.stderr.write("gh_pr_review_feedback.py interrupted\n")
        return 130
