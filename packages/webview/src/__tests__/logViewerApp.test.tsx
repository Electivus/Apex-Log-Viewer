...
import type { LogViewerFromWebviewMessage, LogViewerToWebviewMessage } from '@alv/protocol/logViewerMessages';
import type { LogDiagnostic } from '@alv/protocol/logTriage';
