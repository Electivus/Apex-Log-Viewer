...
import type { LogsColumnKey, NormalizedLogsColumnsConfig } from '@alv/protocol/logsColumns';
import { DEFAULT_LOGS_COLUMNS_CONFIG, normalizeLogsColumnsConfig } from '@alv/protocol/logsColumns';
